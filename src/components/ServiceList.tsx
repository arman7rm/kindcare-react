  ...
  return (
    <section className="bg-gradient-to-b from-[var(--lightgreen)] to-[var(--teal)] px-4 py-16 sm:px-8 md:py-28 lg:py-32">
      ...
      <div 
        ...
        data-aos-once="true"
      >
        <span className="inline-block mb-3 text-lg font-semibold text-[var(--white)] bg-[var(--primary)] px-4 py-2 rounded-full">
          What We Offer
        </span>
        <h2 className="text-4xl font-bold text-[var(--primary)] sm:text-5xl md:text-6xl">
          Comprehensive <span className="text-[var(--white)]">Care Services</span>
        </h2>
        <p className="mt-6 text-xl text-[var(--white)] max-w-3xl mx-auto">
          Delivering exceptional care tailored to your unique needs—because everyone deserves comfort and dignity.
        </p>
      </div>
      ...
      >
        ...
        <p className="mt-4 text-lg text-gray-700">
          Our care specialists can help determine the best solution for your unique situation.
        </p>
        <a
          href="/contact"
          className="mt-6 inline-block rounded-full bg-[var(--primary)] px-8 py-3 text-lg font-bold text-white transition-all hover:bg-[var(--dark-primary)] hover:shadow-lg"
        >
